# -*- coding: utf-8 -*-
#
# orion.algo.hyperopt documentation build configuration file.
#
...
import orion.algo.hyperopt as algo_plugin
...
latex_documents = [
  (master_doc, 'orion.algo.hyperopt.tex',
   u'Oríon algo hyperopt Documentation',
   u'Mike Pieper', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'hyperopt',
   u'Oríon algo hyperopt Documentation',
   author, 'hyperopt', algo_plugin.__descr__,
   'Miscellaneous'),
]
